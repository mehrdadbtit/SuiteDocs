...
You may need to use `{{suitecrm.root}}/legacy/Api/V8/OAuth2` and keep using "/legacy/" prefix for all Api calls, somehow htaccess is not handling the rewrites correctly in v8.6
